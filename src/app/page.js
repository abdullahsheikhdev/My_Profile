...
export default function Home() {
  ...
  return (
    <main className={`min-h-screen flex items-start lg:items-center justify-center p-2 md:p-8 transition-colors duration-300 ${darkMode ? "dark-mode" : "light-mode"}`}>
      <div className="flex flex-col md:flex-row gap-3 md:gap-6 max-w-315 w-full items-center md:items-stretch">
        ...
        {/* Main Content Area */}
        <div className={`flex flex-col lg:flex-row flex-1 h-auto lg:h-160 ${darkMode ? "bg-[#222222] bg-opacity-70" : "bg-white bg-opacity-90"} backdrop-blur-sm rounded-sm shadow-xl w-full p-2 lg:p-0 mt-4 md:mt-0 relative overflow-visible transition-colors duration-300`}>
